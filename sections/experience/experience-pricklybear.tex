...
{Head of Engineering}{Apr 2022 -- Apr 2024}
{Prickly Bear} {NodeJS, C\#, Flutter, Unity, MongoDB, GCP}
  \myItemListStart
    \myItem{Led pivotal tech migrations: Flutter to Unity and Monolithic to NodeJS Microservices, resulting in a 95\% increase in app stability and reducing server response time from 700ms to 400ms.}
