...
{Sandbox Kids}
  \myItemListStart
    ...
    \myItem{Supported the Engineering department's transition to remote working, reviewing tools and processes while funnelling and prioritising requests, reducing the impact of context-switching, and increasing the time engineers spend writing code by 6\%.}
  \myItemListEnd